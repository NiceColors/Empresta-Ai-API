...
const DEFAULT_URL: string = "https://www.amazon.com.br/gp/bestsellers/books/"

const amzScraper = async (url = DEFAULT_URL) => {

    const browser = await puppeteer.launch({
        headless: true, //false para abrir a janela do navegador
    });
